...
class Cluster(models.Model):
	...
	#title = models.CharField(_("Cluster Title"), max_length=100, unique=True)
    
	def __str__(self):
		return '{}'.format(str(self.cluster_id))
...
class Feed(models.Model):
    ...
    rights = models.CharField(_("Rights"), max_length=500, blank=True,
                              null=True)
...
class Post(models.Model):
    ...
    """
    feed = models.ForeignKey("planet.Feed", null=False, blank=False, related_name='posts')
    title = models.CharField(_("Title"), max_length=255, db_index=True)
    ...
    image_url = models.URLField(_("Url"), max_length=255, db_index=True, null=True)
...
# ADDITION OVER HERE
    category = models.ForeignKey(Category, blank=True, null=True,
                                 db_index=True,related_name='categories')
